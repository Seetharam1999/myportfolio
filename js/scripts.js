...
$(function () {
	...
	*/
	$('.menu-btn').click(()=>{
	$('.background.gradient').css('background', '#b121ce');
	$('.background.gradient').css('background', '-webkit-linear-gradient(top left, #b121ce 0%, #239bca 100%)')
	$('.background.gradient').css('background', 'linear-gradient(to bottom right, #b121ce 0%, #239bca 100%);')
...
function initMap() {
	var myLatlng = new google.maps.LatLng(13.06900810592963, 80.27596101021237);
	var styles = [
	{
		"featureType": "water",
		"stylers": [{
...
var words = ['Freelancer','Developer','Travel Enthusiast'],
    part,
    i = 0,
    offset = 0,
    len = words.length,
